...
runSCSData['input']['input_ws']=r'C:\temp\taiwan\444\catchments'
runSCSData['input']['scratch_ws']=r"c:\temp\scratch"

runSCSData['input']['catchment_name']='adjcatchd3km1'
runSCSData['input']['catchment_folder']=r'C:\temp\taiwan\444\catchments\AdjCatchD3km1'
runSCSData['input']['catchment_fn']=os.path.join(runSCSData['input']['input_ws'],runSCSData['input']['catchment_name']+'.shp')

runSCSData['input']['longest_flow_path_name']='LFPAdjCatD3km1b'  #b
runSCSData['input']['drainage_point_name']='DrainPointD3km1'
runSCSData['input']['catchment_landuse_fn']=os.path.join(runSCSData['input']['input_ws'],'soil_landuse_adjcatchd3km1.shp')
needDrainagePoints = False 


isAdj = True  #adj derives the drainage points from longest flow pathes
              #adj use complicated zonal statistics 
...
runSCSData['input']['rain_gauge_fn']=r'C:\temp\taiwan\444\rainfall\Raingauges_ALL-NORTH-ONLY5_TWD97_prj.shp'

runSCSData['intermediate']['slope_zonal_table']=runSCSData['input']['catchment_name']+'_slope'

runSCSData['output']['output_ws'] = r'C:\temp\taiwan\444\scs'
runSCSData['output']['output_rainfall_ws']= r'C:\temp\taiwan\444\rainfall'
runSCSData['output']['output_scs_ws']= r'C:\temp\taiwan\444\scs\scs_models'
